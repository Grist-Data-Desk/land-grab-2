...
<qgis version="3.32.0-Lima">
  <identifier>https://gis.trustlands.utah.gov/mapping/rest/services/Contracts_Oil_Gas/FeatureServer/0</identifier>
  <parentidentifier></parentidentifier>
  <language></language>
  <type>dataset</type>
  <title>Other Business Arrangements (ML 90000+)</title>
  <abstract></abstract>
  <links>
    <link url="https://gis.trustlands.utah.gov/mapping/rest/services/Contracts_Oil_Gas/FeatureServer/0" size="" type="WWW:LINK" description="" format="" name="Source" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
  <encoding></encoding>
