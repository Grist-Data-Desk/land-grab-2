...
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.ca_universityofcalifornia_parser import cauc_parser
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.fl_universityofflorida_parser import fluf_parser
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.nj_rutgersuniversity_parser import njru_parser
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.oh_ohiostateuniversity_parser import ohos_parser
from tasks.to_be_moved.land_grab.university_real_estate import tnut_parser
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.tx_texasaandm_mineral_parser import txam_mineral_parser
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.tx_texasaandm_property_parser import txam_property_parser
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.az_universityofarizona_parser import azua_parser
from land_grab_2.uni_holdings_dataset.also_old_stuff_figure_out.parcel_enrichment.parsers.in_purdueuniversity_parser import inpu_parser
...
def parse_arguments():
    ...
    parser.add_argument('-db-utils', '--database')  # option that takes a value
...
# -o "data_output" -db-utils "/Users/mpr/Documents/01_Current Projects/Grist_LGU2/AZ"
